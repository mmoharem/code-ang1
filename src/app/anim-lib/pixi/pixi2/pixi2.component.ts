import { Component, OnInit, Renderer2, AfterViewInit, ChangeDetectorRef, ViewChild, ElementRef, Input, NgZone, ChangeDetectionStrategy, OnDestroy, OnChanges, SimpleChanges } from '@angular/core';
import { Application, Container, Graphics, Texture } from 'pixi.js';
declare var PIXI: any;

@Component({
  selector: 'anim-lib-pixi2',
  templateUrl: './pixi2.component.html',
  styleUrls: ['./pixi2.component.scss'], 
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class Pixi2Component implements OnInit, AfterViewInit, OnDestroy, OnChanges {
